...
int main(void)
{
	...
	/*External Interrupt on Line 0,1,2,3*/
	EXTI_LINEx  EXTI_L0={EXTI_Line0,
			EXTI_RISING_EDGE};
	EXTI_LINEx  EXTI_L1={EXTI_Line1,
			EXTI_RISING_EDGE};

	EXTI_LINEx  EXTI_L2={EXTI_Line2,
			EXTI_RISING_EDGE};
	EXTI_LINEx  EXTI_L3={EXTI_Line3,
			EXTI_RISING_EDGE};
	...
	EXTI_voidInit(&EXTI_L2);
	EXTI_voidInit(&EXTI_L3);

	/*set call back functions*/
	EXTI_voidSetCallBack(&EXTI_L0,DCM_voidENCAISR);
	EXTI_voidSetCallBack(&EXTI_L1,DCM_voidENCBISR);
	EXTI_voidSetCallBack(&EXTI_L2,DCM_voidENCAISR);
	EXTI_voidSetCallBack(&EXTI_L3,DCM_voidENCBISR);


	DCM_voidInit(&DC_Motor_1);

	DCM_voidInit(&DC_Motor_2);
...
void Motion_Forward()
{
	/* PWM Configurations for Timer1 and Timer2*/
	TIM1->CCR1 = 30 ;
	...
	DCM_voidRotateCCW(&DC_Motor_1);
	DCM_voidRotateCCW(&DC_Motor_2);
}
